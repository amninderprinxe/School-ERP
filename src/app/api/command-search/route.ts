      ...
      if (students.length > 0) {
        groups.push({
          ...
          items: students.map((u) => ({
            id: u.id,
            title: u.name,
            subtitle: u.loginId ?? u.email ?? undefined,
            href: `/school-admin/students/${u.id}`,
            type: "student",
          })),
        });
      }
      ...
      if (teachers.length > 0) {
        groups.push({
          ...
          items: teachers.map((u) => ({
            ...
            href: `/school-admin/teachers/${u.id}`,
            type: "teacher",
          })),
        });
      }
        ...
        if (students.length > 0) {
          groups.push({
            ...
            items: students.map((sp) => ({
              id: sp.user.id,
              title: sp.user.name,
              subtitle: sp.user.loginId ?? sp.user.email ?? undefined,
              href: `/school-admin/students/${sp.user.id}`,
              type: "student",
            })),
          });
        }
