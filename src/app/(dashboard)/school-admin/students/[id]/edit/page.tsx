...
import { updateStudent }        from "@/action/student.actions";
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Reset this student's password to the platform default
            </p>
          </div>
        </div>
        <div className="px-6 py-5 flex flex-col sm:flex-row sm:items-center
          ...
          <div>
            <p className="text-sm text-gray-700">
              Clicking reset will set the student's password to{" "}
              <span className="font-mono font-semibold text-gray-900">
                Password@123
              </span>.
            </p>
            <p className="text-xs text-gray-400 mt-1">
              Notify the student to change it on their next login.
            </p>
          </div>
          <ResetPasswordButton
