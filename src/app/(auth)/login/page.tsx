...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen w-full overflow-y-auto">
      {/* Background Image & Fallback Color Layer */}
      ...
      <div className="relative z-10 flex min-h-screen w-full items-center justify-start px-4 py-10 sm:px-8 lg:px-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <div className="flex items-center justify-between gap-4 pt-1">
                  <button
                    type="submit"
                    disabled={loading}
                    className="inline-flex min-w-28 items-center justify-center gap-2 rounded-md bg-blue-700 px-5 py-3 text-sm font-bold uppercase tracking-wide text-white transition hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-blue-400"
                  >
                    {loading ? (
                      <>
