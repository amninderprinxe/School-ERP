...
const AreaChart: any = ({ children }: any) => <div className="area-chart">{children}</div>;
const Area: any = ({ children }: any) => <g className="area">{children}</g>;
const BarChart: any = ({ children }: any) => <div className="bar-chart">{children}</div>;
const Bar: any = ({ children }: any) => <g className="bar">{children}</g>;
const XAxis: any = (props: any) => <g className="x-axis" />;
const YAxis: any = (props: any) => <g className="y-axis" />;
const CartesianGrid: any = (props: any) => <g className="cartesian-grid" />;
const Tooltip: any = (props: any) => null; // custom tooltip used elsewhere
const ResponsiveContainer: any = ({ children }: any) => <div className="responsive">{children}</div>;
const Cell: any = (props: any) => <g className="cell" />;
const Legend: any = (props: any) => <div className="legend" />;
const PieChart: any = ({ children }: any) => <div className="pie-chart">{children}</div>;
const Pie: any = ({ children }: any) => <g className="pie">{children}</g>;
// Small local replacement for missing ./kpi-card
function formatKpiValue(value: number, type?: "currency" | "compact") {
  if (type === "currency") {
    // show as simple currency with thousands separator, no decimals
    return `$${Math.round(value).toLocaleString()}`;
  }
  // compact fallback (e.g., 1.2K, 3M)
