    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm text-gray-500">
          {sectionLabel} · Click any cell to edit
        </p>
        <button
          type="button"
          ...
          <table className="w-full border-collapse">
            ...
            <thead>
              <tr>
                ...
                <th className="w-20 px-3 py-3.5 bg-gray-50 border-b
                ...
                {activeDays.map((day) => (
                  <th
                    ...
                    className="min-w-[140px] px-3 py-3.5 bg-gray-50 border-b
                      ...
                      font-semibold text-gray-700 uppercase tracking-wide
                      text-center"
                  >
                        ...
                        >
                          <button
                            ...
                            className={[
                              ...
                              isSelected
                                ? "ring-2 ring-blue-500 ring-offset-1 scale-[0.98]"
                                : "",
                            ...
                            {period?.subjectId ? (
                              <div className="flex flex-col gap-0.5">
                                ...
                                {(period.startTime || period.endTime) && (
                                  <p className="text-[10px] opacity-60 flex
                                    items-center gap-0.5 mt-0.5">
          ...
          <div className="flex items-center justify-between px-5 py-3.5
            ...
            <div>
              <p className="text-sm font-bold text-blue-900">
                Edit Period {selected.period} —{" "}
                {DAY_LABEL[selected.day]}
              </p>
              <p className="text-xs text-blue-600 mt-0.5">{sectionLabel}</p>
            </div>
            <button
              type="button"
              onClick={() => { setSelected(null); setFeedback(null); }}
              className="p-1.5 text-blue-400 hover:text-blue-700
              ...
              {periodMap.has(`${selected.day}-${selected.period}`) && (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5
                    ...
                    text-red-600 text-sm font-semibold rounded-lg
