...
import {
  ...
  Megaphone, CalendarCheck, Award, Baby, X,
  type LucideIcon,
} from "lucide-react";
...
const ICON_MAP: Record<string, LucideIcon> = {
  LayoutDashboard, Building2, Users, Settings,
  GraduationCap, UserCheck, BookOpen, BookMarked,
  Megaphone, CalendarCheck, Award, Baby,
};
    ...
    <div className="flex h-full flex-col bg-slate-900">
      ...
      <div className="px-3 pb-4 pt-3 border-t border-slate-700/60 shrink-0">
        <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-slate-800 transition-colors cursor-default">
          <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0 shadow-md">
